...
- Scalability notes:
  ...
  - Intermediate-analysis pyramids are not generated by default; visualization prefers existing pyramids and falls back to single-scale data when unavailable.
